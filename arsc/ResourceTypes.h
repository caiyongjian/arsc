...
struct ResTable_config
{
	...
	enum {
		...
		SHIFT_NAVHIDDEN = 2,
		NAVHIDDEN_ANY = 0x0000 << SHIFT_NAVHIDDEN,
		NAVHIDDEN_NO = 0x0001 << SHIFT_NAVHIDDEN,
		NAVHIDDEN_YES = 0x0002 << SHIFT_NAVHIDDEN,
	};
...
public:
    ...
    // to distinguish null.
    const QString string8ObjectAt(size_t idx) const;
